        ...
        if($type=='chat')
        {
            ...
            $customer = CustomerInfo::where('user_id',$support->created_by)->first();
               ...
               if($customer->profile_image)
               {
                ...
                $imagec=url('/storage/app/public/customer_profile/'.$customer->profile_image);
               } 
               else
               {
             ...
             $seller = SellerInfo::where('seller_id',$support->seller_id)->first(); 
               ...
               {
                 $images=config('app.storage_url').$seller->store($seller->seller_id)->logo;
               }
            //   if($seller->avatar)
            //   {
           ...
           {  
             ...
             {  
               ...
               if($customer->profile_image)
               {
                ...
                $image=url('/storage/app/public/customer_profile/'.$customer->profile_image);
               } 
               else
               {
