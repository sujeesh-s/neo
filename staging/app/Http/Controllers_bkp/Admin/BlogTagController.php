...
class BlogTagController extends Controller
{
    ...
    public function create(){ 
        ...
        $data['products']           =    AdminProduct::where('is_deleted',NULL)->orWhere('is_deleted',0)->where('is_active',1)->get();
    ...
    public function save(Request $request){ 
        ...
        $niceNames = ['bt_name' => 'Tag Name','bt_category' => 'Category Name','bt_product' => 'Product Name']; 
        ...
        { 
            ...
            $blogtag->bt_category          =   $request->get('bt_category');
            $blogtag->bt_product           =   $request->get('bt_product');
