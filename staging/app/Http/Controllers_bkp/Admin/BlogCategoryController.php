...
class BlogCategoryController extends Controller
{
    ...
    public function save(Request $request){ 
        ...
        else
        {
            ...
            $blogcategory->save();
            Session::flash('message', ['text'=>'Blog category created successfully','type'=>'success']);
    ...
    public function update(Request $request,$bcat_id){ 
        ...
        else
        {
            ...
            $blogcategory->updated_by           =   auth()->user()->id;
            $blogcategory->save();
            Session::flash('message', ['text'=>'Blog Category updated successfully','type'=>'success']);
            return redirect(route('admin.blogcategories'));
        }
    ...
    public function updatestatus(Request $request){ 
        ...
        $blogcategory->updated_by =   auth()->user()->id;
        $blogcategory->save();
        return response()->json(['success'=>'Blog Category status changed successfully.']);
    }
