         ...
         @endphp
                                                              ...
                                                              <p class="view_value"> @foreach ($language as $lang)
																...
																<div class="row">
																	<div class="col">
																		<div class="form-group">
																			...
																			<p class="view_value">{{ $brand['brand_name'] }}</p>
																...
																<div class="row">
																	<div class="col mb-3">
																		<div class="form-group">
																			...
																			<p class="view_value">{{ $brand['brand_desc'] }}</p>
																...
																<div class="col">
																	...
																	<p class="view_value">@if($brand['is_active'] ==1){{ "Active" }}@else{{ "Inactive" }}@endif</p>
														...
														<div class="row" style="margin-top: 30px;">
															<div class="col d-flex justify-content-end">
															     <a href="{{url('/admin/brands')}}"  class="mr-2 btn btn-secondary" >Back</a>  
