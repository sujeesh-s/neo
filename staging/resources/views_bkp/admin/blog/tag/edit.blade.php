                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <textarea class="form-control" placeholder="Description" name="bt_description">{{ $blog_tag->bt_description }}</textarea>
                                                            </div>
                                                        </div>
                                                         <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label class="form-label">Category</label>
                                                                <select class="form-control custom-select" name="bt_category" id="bt_category"  >
                                                                  <!--   <option value="">Select Category</option> -->
                                                                    @if($categories && count($categories) > 0)
                                                                    @foreach ($categories as $row)
                                                                    <option value="{{ $row->bc_id }}" <?php if(isset($blog_tag->bt_category)) { if($blog_tag->bt_category == $row->bc_id) { echo 'selected'; } } ?>>{{ $row->bc_name }}</option>
                                                                    @endforeach
                                                                    @endif
                                                                </select>
                                                         ...
                                                         <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label class="form-label">Products</label>
                                                                 <select class="form-control custom-select" name="bt_product" id="bt_category"  >
                                                                  <!--   <option value="">Select Product</option> -->
                                                                    @if($products && count($products) > 0)
                                                                    @foreach ($products as $prd) 

                                                                    <option value="{{ $prd->id }}" <?php if(isset($blog_tag->bt_product)) { if($blog_tag->bt_product == $prd->id) { echo 'selected'; } } ?> >{{ $prd->name }}</option>
                                                                    @endforeach
                                                                    @endif
