  ...
  $def_lang =DB::table('glo_lang_lk')->where('is_active', 1)->first();
        ...
        $lang_id = $content_table->lang_id;
         ...
         @endphp
															...
															<input class="form-control" name="valid_from" value="{{ $tax['valid_from'] }}" type="text" onchange="date_check()" readonly />
															...
															data-date-format="yyyy-mm-dd">
															<input class="form-control"  name="valid_to" value="{{ $tax['valid_to'] }}" type="text" onchange="date_check()" readonly />
															<span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
															</div>
															@error('valid_to')
															<p style="color: red">{{ $message }}</p>
															...
															<input type="number" step="0.01" min="0" max="100" value="{{ $tax['percentage'] }}" name="percentage" class="form-control">
															@error('percentage')
															<p style="color: red">{{ $message }}</p>
															@enderror
															</div>
