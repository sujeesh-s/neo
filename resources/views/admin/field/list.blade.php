...
@php $row = 0; @endphp
<div id="list_form"> @include('admin.field.list.content')</div>
<div id="dtl_form">  </div>
@section('js') 
    ...
    $(document).ready(function(){ 
        ...
        $('body').on('click','.deletefield',function(){
           ...
           // alert(id);
            var status      =   1;
            var url         =   '{{url("admin/field/deletefieldval")}}';
        ...
        $('body').on('click','.viewDtl',function(){ 
            ...
            $.ajax({
                type: "GET",
                url: '{{url("admin/field/detail")}}/'+id+'/view',
                success: function (data) {
                    $('#dtl_form').html(data); $('#dtl_form').fadeIn(700); $('#list_form').hide();
                } 
            });
        ...
        $("body").on("change", ".status-btn", function () {
            ...
            var url         =   '{{url("admin/field/updateStatus")}}';
