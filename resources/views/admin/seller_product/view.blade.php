            ...
            {{ Form::open(array('url' => "my-products/product/save", 'id' => 'adminForm', 'name' => 'adminForm', 'class' => '','files'=>'true')) }}
                ...
                <div class="row panel-body tabs-menu-body">
                    <div class="tab-content col-12">
                        @include('admin.seller_product.view.general')
                        @include('admin.seller_product.view.price_tax')
                        @include('admin.seller_product.view.image')
                        @include('admin.seller_product.view.attribute')
                        @include('admin.seller_product.view.reviews')
