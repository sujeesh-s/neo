...
<div class="page-header">
    <div class="page-leftheader">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a id="bc_list" href="">Order List</a></li>
...
<div class="col-lg-12 col-md-12">
    <div class="card">
        <div class="card-body pb-2">
            {{ Form::open(array('url' => "/sales/order/updateStatus", 'id' => 'adminForm', 'name' => 'adminForm', 'class' => '','files'=>'true')) }}
                 {{Form::hidden('id',$order->id,['id'=>'id'])}} 
                 {{Form::hidden('start_date',$filter->start_date,['id'=>'start_date'])}} {{Form::hidden('end_date',$filter->end_date,['id'=>'end_date'])}} 

                <div class="tabs-menu mb-4">
                    <ul class="nav panel-tabs">
                        <li><a href="#tab1" data-toggle="tab" id="nav_tab_1" class="active"><span>General Info.</span></a></li>
                        <li><a href="#tab2" data-toggle="tab" id="nav_tab_2"><span>Items</span></a></li>
                        <li><a href="#tab3" data-toggle="tab" id="nav_tab_3"><span>Billing Address</span></a></li>
                        <li><a href="#tab4" data-toggle="tab" id="nav_tab_4"><span>Shipping Address</span></a></li><!--
