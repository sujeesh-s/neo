						...
						<div class="page-header">
							<div class="page-leftheader">
								...
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page"><a href="#">New Category</a></li>
								</ol>
							</div>
							...
							<div class="col-12">
								...
								<div class="row flex-lg-nowrap">
									<div class="col-12 mb-3">
										<div class="card">
                                            <div class="card-body">
                                                <form action="{{url('admin/blog/savecategory')}}" method="POST" enctype="multipart/form-data">
													    @csrf
                                                        <div class="row">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control @error('bc_name') is-invalid @enderror" placeholder="Category Name" value="{{ old('bc_name') }}"  name="bc_name">
                                                                @error('bc_name')
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <textarea class="form-control @error('bc_description') is-invalid @enderror" placeholder="Description" name="bc_description">{{ old('bc_description') }}</textarea>
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control @error('bc_faicon') is-invalid @enderror" placeholder="Category fa icon code Ex:fa fa-home," value="{{ old('bc_faicon') }}"  name="bc_faicon">
                                                                @error('bc_faicon')
                                                                    <span class="invalid-feedback" role="alert">
                                                                        <strong>{{ $message }}</strong>
                                                                    </span>
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" min="1" class="form-control @error('bc_sortorder') is-invalid @enderror" placeholder="Category Sort Order" value="{{ old('bc_sortorder') }}"  name="bc_sortorder">
                                                                @error('bc_sortorder')
                                                                    <span class="invalid-feedback" role="alert">
                                                                        <strong>{{ $message }}</strong>
                                                                    </span>
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control @error('bc_seo_tag') is-invalid @enderror" placeholder="Category Seo Tags" value="{{ old('bc_seo_tag') }}"  name="bc_seo_tag">
                                                                @error('bc_seo_tag')
                                                                    <span class="invalid-feedback" role="alert">
                                                                        <strong>{{ $message }}</strong>
                                                                    </span>
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control @error('bc_seo_title') is-invalid @enderror" placeholder="Category Seo Title" value="{{ old('bc_seo_title') }}"  name="bc_seo_title">
                                                                @error('bc_seo_title')
                                                                    <span class="invalid-feedback" role="alert">
                                                                        <strong>{{ $message }}</strong>
                                                                    </span>
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <textarea class="form-control @error('bc_seo_description') is-invalid @enderror" placeholder="Seo Description" name="bc_seo_description">{{ old('bc_seo_description') }}</textarea>
