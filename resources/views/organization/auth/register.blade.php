								...
								<div class="text-white">
									<div class="card-body">
										...
										<div class="text-center pt-4">
											<div class="font-weight-normal fs-16">You Already have an account <a class="btn-link font-weight-normal text-white-80" href="{{url('/seller/login')}}">Login Here</a></div>
										</div>
									</div>
