...
@section('page-header')
						...
						<div class="page-header">
							<div class="page-leftheader">
								<h4 class="page-title mb-0">Add Tag</h4>
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page"><a href="#">New Tag</a></li>
								</ol>
							</div>
							...
							<div class="col-12">
								...
								<div class="row flex-lg-nowrap">
									<div class="col-12 mb-3">
										<div class="card">
                                            <div class="card-body">
                                                <form action="{{url('admin/blog/savetag')}}" method="POST" enctype="multipart/form-data">
													    @csrf
                                                        <div class="row">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control @error('bt_name') is-invalid @enderror" placeholder="Tag Name" value="{{ old('bt_name') }}"  name="bt_name">
                                                                @error('bt_name')
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <textarea class="form-control" placeholder="Description" name="bt_description">{{ old('bt_description') }}</textarea>
                                                            </div>
                                                        </div>
                                                         <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label class="form-label">Category<span class="text-red">*</span></label>
                                                                <select class="form-control custom-select @error('bt_category') is-invalid @enderror" name="bt_category" id="bt_category"  >
                                                                    <option value="">Select Category</label></option>
                                                                    @if($categories && count($categories) > 0)
                                                                    @foreach ($categories as $row)
                                                                    <option {{ old('bt_category') == $row->bc_id ? "selected" : "" }} value="{{ $row->bc_id }}">{{ $row->bc_name }}</option>
                                                                    @endforeach
                                                                    @endif
                                                                </select>
                                                                 @error('bt_category')
                                                         ...
                                                         <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label class="form-label">Products<span class="text-red">*</span></label></label>
                                                                 <select class="form-control custom-select @error('bt_product') is-invalid @enderror" name="bt_product" id="bt_product"  >
                                                                    <option value="">Select Product</option>
                                                                    @if($products && count($products) > 0)
                                                                    @foreach ($products as $prd) 

                                                                    <option {{ old('bt_product') == $prd->id ? "selected" : "" }} value="{{ $prd->id }}">{{ $prd->name }}</option>
                                                                    @endforeach
                                                                    @endif
                                                                </select>
                                                                @error('bt_product')
...
<script type="text/javascript">
	$(document).ready(function () {
            $('#blog_atag').addClass("active");
            $('#blog_tag').addClass("active");
